...
<head>
	...
	<!-- Page Title -->
    <title>{{ !empty($pageGlobalData->setting) ? $pageGlobalData->setting->site_name : "Church" }} - The Refuge</title>
	<!-- Favicon Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontAssets/images/favicon.png') }}">
	<!-- Google Fonts Css-->
	...
	<link href="{{ asset('frontAssets/css/all.css') }}" rel="stylesheet" media="screen">
	<!-- Animated Css -->
    ...
    <!-- Audio Css File -->
	<link rel="stylesheet" href="{{ asset('frontAssets/css/plyr.css') }}">
	<!-- Main Custom Css -->
...
<body>
	...
	<div class="preloader">
		<div class="loading-container">
			...
			<div id="loading-icon"><img src="frontAssets/images/loader.svg" alt=""></div>
		</div>
	</div>
	<!-- Preloader End -->
			...
			<nav class="navbar navbar-expand-lg">
				<div class="container">
					...
					<a class="navbar-brand" href="index.html">
						<img src="frontAssets/images/logo.svg" alt="Logo">
					</a>
					<!-- Logo End -->
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="hero-slide">
                            ...
                            <div class="hero-slider-image">
                                <img src="frontAssets/images/hero-bg.jpg" alt="">
                            </div>
                            <!-- Slider Image End -->
                    ...
                    <div class="swiper-slide">
                        <div class="hero-slide">
                            <!-- Slider Image Start -->
                            <div class="hero-slider-image">
                                <img src="frontAssets/images/hero-bg-2.jpg" alt="">
                            </div>
                            <!-- Slider Image End -->
    ...
    <div class="our-scrolling-ticker">
        ...
        <div class="scrolling-ticker-box">
            <div class="scrolling-content">
                <span><img src="frontAssets/images/icon-sparkles.svg" alt="">Love Your Neighbor as yourself</span>
                <span><img src="frontAssets/images/icon-sparkles.svg" alt="">Love Your Neighbor as yourself</span>
                <span><img src="frontAssets/images/icon-sparkles.svg" alt="">Love Your Neighbor as yourself</span>
                <span><img src="frontAssets/images/icon-sparkles.svg" alt="">Love Your Neighbor as yourself</span>
                <span><img src="frontAssets/images/icon-sparkles.svg" alt="">Love Your Neighbor as yourself</span>
                    ...
                    <div class="about-image">
                        <div class="about-img-1">
                            <figure class="image-anime reveal">
                                <img src="frontAssets/images/about-us-img-1.jpg" alt="">
                            </figure>
                        </div>

                        <div class="about-img-2">
                            <figure class="image-anime reveal">
                                <img src="frontAssets/images/about-us-img-2.jpg" alt="">
                            </figure>
                        </div>
                    </div>
                    <!-- About Image End -->
                    ...
                    <div class="about-content">
                        ...
                        <div class="about-content-body">
                            ...
                            <div class="about-list-item wow fadeInUp">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-about-list-1.svg" alt="">
                                </div>
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.25s">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-about-list-2.svg" alt="">
                                </div>
                                <div class="about-list-item-content">
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.5s">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-about-list-3.svg" alt="">
                                </div>
                                <div class="about-list-item-content">
                            ...
                            <div class="about-list-item wow fadeInUp" data-wow-delay="0.75s">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-about-list-4.svg" alt="">
                                </div>
                                <div class="about-list-item-content">
                    ...
                    <div class="highlighted-worship-item wow fadeInUp">
                        ...
                        <div class="highlighted-worship-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                                    <img src="frontAssets/images/join-worship-img-1.jpg" alt="">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="highlighted-worship-body">
                            ...
                            <div class="highlighted-worship-btn">
                                <a href="#" class="readmore-btn"><img src="frontAssets/images/arrow-white.svg" alt=""></a>
                            </div>
                        </div>
                    ...
                    <div class="worship-box">
                        ...
                        <div class="worship-item wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="worship-image">
                                <figure>
                                    <a href="#" class="image-anime" data-cursor-text="View">
                                        <img src="frontAssets/images/join-worship-img-2.jpg" alt="">
                                    </a>
                                </figure>
                            </div>
                            <!-- Worship Image End -->
                        ...
                        <div class="worship-item wow fadeInUp" data-wow-delay="0.5s">
                            ...
                            <div class="worship-image">
                                <figure>
                                    <a href="#" class="image-anime" data-cursor-text="View">
                                        <img src="frontAssets/images/join-worship-img-3.jpg" alt="">
                                    </a>
                                </figure>
                            </div>
                            <!-- Worship Image End -->
                        ...
                        <div class="worship-item wow fadeInUp" data-wow-delay="0.75s">
                            ...
                            <div class="worship-image">
                                <figure>
                                    <a href="#" class="image-anime" data-cursor-text="View">
                                        <img src="frontAssets/images/join-worship-img-4.jpg" alt="">
                                    </a>
                                </figure>
                            </div>
                            <!-- Worship Image End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mission-image">
                        ...
                        <div class="mission-img">
                            <figure class="image-anime reveal">
                                <img src="frontAssets/images/mission-image.jpg" alt="">
                            </figure>
                        </div>
                        <!-- Mission Image End -->
                        ...
                        <div class="mission-life-circle">
                            <img src="frontAssets/images/mission-life-circle-img.png" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="frontAssets/images/icon-service-1.svg" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.25s">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="frontAssets/images/icon-service-2.svg" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.5s">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="frontAssets/images/icon-service-3.svg" alt="">
                        </div>
                        <!-- Icon Box End -->
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.75s">
                        <!-- Icon Box Start -->
                        <div class="icon-box">
                            <img src="frontAssets/images/icon-service-4.svg" alt="">
                        </div>
                        <!-- Icon Box End -->
	...
	<div class="service-ticker">
		<div class="scrolling-ticker">
            <div class="scrolling-ticker-box">
                <div class="scrolling-content">
                    <span><img src="frontAssets/images/icon-asterisk.svg" alt="">Hope Of All</span>					
                    <span><img src="frontAssets/images/icon-asterisk.svg" alt="">Hope Of All</span>				
                    <span><img src="frontAssets/images/icon-asterisk.svg" alt="">Hope Of All</span>				
                    <span><img src="frontAssets/images/icon-asterisk.svg" alt="">Hope Of All</span>				
                    <span><img src="frontAssets/images/icon-asterisk.svg" alt="">Hope Of All</span>				
                ...
                <div class="col-md-4">
                    ...
                    <div class="ministries-item wow fadeInUp">
                        ...
                        <div class="ministries-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                                    <img src="frontAssets/images/ministries-img-1.jpg" alt="">
                                </figure>
                            </a>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="ministries-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="ministries-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                                    <img src="frontAssets/images/ministries-img-2.jpg" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Ministries Image End -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="ministries-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="ministries-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                                    <img src="frontAssets/images/ministries-img-3.jpg" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Ministries Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="sermons-item wow fadeInUp">
                        ...
                        <div class="sermons-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                                    <img src="frontAssets/images/sermons-img-1.jpg" alt="">
                                </a>
                            </figure>
                            <!-- Sermons Meta Start -->
                            ...
                            <div class="sermons-audio-icon">
                                <a href="#"><img src="frontAssets/images/audio-play-icon.svg" alt=""></a>
                            </div>
                        </div>
                        <!-- Sermons Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="sermons-item wow fadeInUp" data-wow-delay="0.25s">
                        ...
                        <div class="sermons-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                                    <img src="frontAssets/images/sermons-img-2.jpg" alt="">
                                </a>
                            </figure>
                            <!-- Sermons Meta Start -->
                            <div class="sermons-meta">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="sermons-item wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="sermons-image">
                            <figure>
                                <a href="#" class="image-anime" data-cursor-text="View">
                                    <img src="frontAssets/images/sermons-img-3.jpg" alt="">
                                </a>
                            </figure>
                            <!-- Sermons Meta Start -->
                            <div class="sermons-meta">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="event-image">
                        <figure class="image-anime reveal">
                            <img src="frontAssets/images/event-image.jpg" alt="">
                        </figure>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="about-footer">
                        ...
                        <div class="footer-logo">
                            <img src="frontAssets/images/footer-logo.svg" alt="">
                        </div>
                        <!-- Footer Logo End -->
                    ...
                    <div class="footer-contact">
                        ...
                        <div class="footer-contact-details">
                            ...
                            <div class="footer-info-box">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-phone.svg" alt="">
                                </div>
                            ...
                            <div class="footer-info-box">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-mail.svg" alt="">
                                </div>
                                <div class="footer-info-box-content">
                            ...
                            <div class="footer-info-box">
                                <div class="icon-box">
                                    <img src="frontAssets/images/icon-location.svg" alt="">
                                </div>
                                <div class="footer-info-box-content">
    ...
    <!-- Audio js File -->
    <script src="{{ asset('frontAssets/js/plyr.js') }}"></script>
    <!-- Wow js file -->
